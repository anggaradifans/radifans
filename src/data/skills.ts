...
export const skills: Skill[] = [
  ...
  { name: 'Nuxt.js', category: 'Frontend', icon: 'logos:nuxt-icon', color: '#00DC82' },
  ...
  { name: 'Go', category: 'Backend', icon: 'logos:go', color: '#00ADD8' },
  ...
  { name: 'Supabase', category: 'Database', icon: 'logos:supabase-icon', color: '#3FCF8E' },
  ...
  { name: 'GitHub', category: 'Tools', icon: 'simple-icons:github', color: '#ffffff' },
  { name: 'GitLab', category: 'Tools', icon: 'logos:gitlab-icon', color: '#FC6D26' },
];
