...
const TypewriterText = ({ text }: { text: string }) => {
  ...
  return (
    <motion.h1 className="text-4xl md:text-5xl font-bold mb-2 text-blue-500 font-gaming">
...
export default function Overview() {
  return (
    <section className="mb-8 relative z-10 pt-8 pb-4 font-gaming text-blue-300">
        ...
        >
          {skills.map((skill, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-1 text-blue-400">{skill.name}</h3>
